...
//   -filter_complex "[0:v]scale=640:480[v0];[1:v]scale=640:480[v1];[v0][v1]gltransition=duration=0.5:offset=5:source=crosswarp.glsl" 
...
//AVFILTER_DEFINE_CLASS(gltransition);
